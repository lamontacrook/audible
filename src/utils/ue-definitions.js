        ...
        'components': [
          {
            ...
            'plugins': {
              'aem': {
                'cf': {
                  'name': 'teaser',
                  'cfModel': '/conf/audible/settings/dam/cfm/models/teaser',
          ...
          },
          {
            ...
            'plugins': {
              'aem': {
                'cf': {
                  'name': 'image-list',
                  'cfModel': '/conf/audible/settings/dam/cfm/models/image-list',
                  'cfFolder': `/content/dam/${context.project}/site/en/shared/`,
                  'title': 'Image List',
          ...
          },
          {
            ...
            'plugins': {
              'aem': {
                'cf': {
                  'name': 'article',
                  'cfModel': '/conf/audible/settings/dam/cfm/models/magazine-article',
                  'cfFolder': `/content/dam/${context.project}/site/en/shared/`,
                  'title': 'Article',
